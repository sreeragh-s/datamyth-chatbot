...
export function SessionHistoryChatPage({ channelId, onSessionSelect, onRefreshSession }: SessionHistoryProps) {
  ...
  return (
    <div className=" w-72 h-full rounded-bl-md rounded-tl-md bg-white border border-gray-200  z-10">
